        ...
        const loadCore = async () => {
            ...
            try {
                ...
                setEmployee({
                    name: display,
                    avatar: null,
                    profileImage: u.profileImage || u.profilePictureUrl || null,
                    department: u.department || '',
                    hireDate: u.hireDate || (u.startDate ? new Date(u.startDate).toISOString().split('T')[0] : ''),
                    employeeId: u.employeeId || uid,
                    manager: managerName || u?.managerUserId,
                    role: u.primaryRole || u.hrRole || '',
                    siteId: u.siteId || '',
